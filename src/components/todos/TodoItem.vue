  ...
  <base-card>
    <div class="flex items-center group">
      <input
        ...
        type="checkbox"
        :id="id"
        class="checker w-5 h-5 sm:w-7 sm:h-7 mr-5  appearance-none border border-veryLightGrayishBlue dark:border-darkGrayishBlueDark rounded-full cursor-pointer ring- relative ease-in-out duration-300 checked:border-none"
        :checked="isCompleted"
      />
      <label
        :for="id"
